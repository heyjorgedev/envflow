<x-layouts.app title="About">
    ...
    <div class=" flex flex-col gap-4">
        ...
        <section class="pt-12">
            <h2 class="text-sm font-medium pb-4 text-center">Powered by</h2>
            <div class="flex justify-center">
                <a href="https://upstash.com/" target="_blank" class="border dark:border-slate-700 p-6 rounded-lg flex flex-col gap-4" aria-label="Upstash">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 text-[#050505] dark:text-white" viewBox="0 0 1631 472" fill="none" aria-label="Upstash Logo">
